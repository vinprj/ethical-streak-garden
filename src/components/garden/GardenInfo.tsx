...
export const GardenInfo: React.FC = () => {
  return <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              <div className={cn("p-4 rounded-lg bg-secondary/50", "border border-border transition-all duration-200")}>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  flowering → fruiting, based on your habit streak.
                </p>
              </div>
              ...
              <div className={cn("p-4 rounded-lg bg-secondary/50", "border border-border transition-all duration-200")}>
                ...
                <p className="text-sm text-muted-foreground">
                  Different habit categories grow different types of plants: health (vegetables), 
      ...
      <div className="bg-card rounded-lg border p-6">
        ...
        <p className="mb-4">
          We've designed the Habit Garden with both accessibility and environmental consciousness in mind:
        </p>
